...
func NewOpenRouterAdapter(cfg config.ProviderConfig, errorConfig config.ErrorConfig) *OpenRouterAdapter {
...
func (a *OpenRouterAdapter) getNextAccount() (string, string) {
	a.accountMu.Lock()
