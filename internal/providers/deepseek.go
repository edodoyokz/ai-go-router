...
// DeepSeekAdapter implements the Adapter interface for DeepSeek's OpenAI-compatible API
...
func NewDeepSeekAdapter(cfg config.ProviderConfig, errorConfig config.ErrorConfig) *DeepSeekAdapter {
...
func (a *DeepSeekAdapter) getNextAccount() (string, string) {
	a.accountMu.Lock()
...
func (a *DeepSeekAdapter) ChatCompletion(ctx context.Context, request ChatRequest, model string) (ChatResponse, error) {
